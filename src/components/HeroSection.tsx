...
const HeroSection = () => {
  return <>
      <section className="relative bg-white/70 backdrop-blur-sm py-20 lg:py-32 overflow-hidden" itemScope itemType="http://schema.org/Organization">
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
            <div className="lg:col-span-7">
              <div className="text-center lg:text-left">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  ...
                  <span className="text-[#8AA6C1]">Virtuelle Assistenz & Buchhaltung</span> <br />
                  für KMU in der Schweiz
                </h1>
                <p className="mt-6 text-xl text-gray-600 max-w-3xl">
                  Virtuell stark, persönlich nah. <span className="font-semibold text-[#8AA6C1]">Gewinnen Sie Zeit für Ihr Kerngeschäft – wir übernehmen Administration, Finanzen und mehr, remote und flexibel.</span>
                </p>
                
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <Button asChild size="lg" className="bg-gradient-to-br from-[#8AA6C1] to-[#B8CCDE] hover:from-[#7A96B1] hover:to-[#A8BCCE] text-white text-lg px-8 py-3 transition-all duration-300 hover:shadow-md">
                  ...
                  <Button asChild variant="outline" size="lg" className="text-[#8AA6C1] border-[#8AA6C1]/30 hover:bg-[#8AA6C1]/10 text-lg px-8 py-3 transition-all duration-300">
                    <Link to="/leistungen">
            ...
            <div className="mt-12 lg:mt-0 lg:col-span-5">
              <div className="relative">
                <div className="aspect-w-1 aspect-h-1 bg-gradient-to-br from-[#8AA6C1] to-[#B8CCDE] rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="absolute -top-4 -right-4 bg-white rounded-lg shadow-lg p-3 max-w-xs transition-opacity duration-500 opacity-90 hover:opacity-100">
                  <div className="flex items-center space-x-2">
                    <Users className="w-5 h-5 text-[#8AA6C1]" />
                ...
                <div className="absolute -bottom-4 -left-4 bg-white rounded-lg shadow-lg p-3 max-w-xs transition-opacity duration-500 opacity-90 hover:opacity-100">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#8AA6C1]">10+</div>
