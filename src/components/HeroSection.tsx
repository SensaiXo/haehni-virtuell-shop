            ...
            <div className="mt-12 lg:mt-0 lg:col-span-5">
              <div className="relative">
                <div className="aspect-w-1 aspect-h-1 bg-gradient-to-br from-blue-400 to-blue-700 rounded-2xl shadow-2xl overflow-hidden">
                  <img alt="Laura Hähni – Virtuelle Assistentin und Buchhalterin für KMU in der Schweiz" className="w-full h-full object-cover" loading="lazy" src="/lovable-uploads/6c7e7ce3-b643-4f54-9689-e32284bd32f9.png" />
                </div>
                {/* Floating elements */}
